...
export default function ProfileSetup({ username, email, onComplete }: ProfileSetupProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const fetchedUsername = userData?.username || username || '';
      const fetchedEmail = userData?.email || email || '';
